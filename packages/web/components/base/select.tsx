		...
		<SelectPrimitive.Trigger
			...
			className={cn(
				variant === "secondary"
					...
					: "flex items-center gap-1.5 rounded-2xl border border-field-border bg-field px-3 py-2 text-sm text-field-foreground whitespace-nowrap transition-[color,box-shadow] duration-200 outline-none focus-visible:border-ring focus-visible:ring-1 focus-visible:ring-ring disabled:disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-1 aria-invalid:ring-destructive/60 data-[size=default]:h-8 data-[size=sm]:h-7 data-placeholder:text-field-placeholder dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40",
